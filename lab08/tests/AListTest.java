...
//     Uncomment the below if you want to test locally.
    ...
    public void testHasNext() {
        ...
        assertWithMessage("Iterator should be empty for an empty AList so hasNext() should return false").that(!it1.hasNext()).isTrue();
        a.addLast(1);
        a.addLast(2);
        a.addLast(3);
        Iterator<Integer> it2 = a.iterator();
        assertWithMessage("Iterator should have elements left so hasNext() should return true").that(it2.hasNext()).isTrue();
    }
    ...
    public void testNext() {
        ...
        assertWithMessage("Iterator should have elements left so hasNext() should return true").that(it.hasNext()).isTrue();
        assertWithMessage("First call to next() should return 1").that(it.next()).isEqualTo(1);
        assertWithMessage("Iterator should have elements left so hasNext() should return true").that(it.hasNext()).isTrue();
        assertWithMessage("First call to next() should return 2").that(it.next()).isEqualTo(2);
        assertWithMessage("Iterator should have elements left so hasNext() should return true").that(it.hasNext()).isTrue();
        assertWithMessage("First call to next() should return 3").that(it.next()).isEqualTo(3);
        assertWithMessage("Iterator should be empty so hasNext() should return false").that(!it.hasNext()).isTrue();
    }
    ...
    public void testIteratorIndependence() {
        ...
        assertWithMessage("i1 should have elements left so hasNext() should return true").that(i1.hasNext()).isTrue();
        assertWithMessage("i2 should have elements left so hasNext() should return true").that(i2.hasNext()).isTrue();

        i1.next();
        i1.next();
        i1.next();
        assertWithMessage("i1 should have no elements left so hasNext() should return false").that(!i1.hasNext()).isTrue();
        assertWithMessage("i2 should have elements left so hasNext() should return true").that(i2.hasNext()).isTrue();
        ...
        assertWithMessage("i2 should have no elements left so hasNext() should return false").that(!i2.hasNext()).isTrue();
        assertWithMessage("i1 should have no elements left so hasNext() should return false").that(!i1.hasNext()).isTrue();
